...
/**
 * Class Checkoutcom_Ckopayment_Model_CheckoutcomGooglePay
 */
class Checkoutcom_Ckopayment_Model_CheckoutcomGooglePay extends Mage_Payment_Model_Method_Cc
{
    protected $_code = Checkoutcom_Ckopayment_Helper_Data::CODE_CHECKOUT_COM_GOOGLEPAY;
    protected $_formBlockType = 'ckopayment/form_checkoutcomGooglePay';
    protected $_infoBlockType = 'ckopayment/info_checkoutcomGooglePay';
    ...
    public function authorize(Varien_Object $payment, $amount)
    {
        ...
        if (empty($requestData['google_cko_card_token'])) {
        ...
        // card token
        $cardToken = $requestData['google_cko_card_token'];
        $currencyCode = Mage::app()->getStore()->getCurrentCurrencyCode();
