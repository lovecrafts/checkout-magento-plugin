...
$installer->run("
CREATE TABLE `{$installer->getTable('chargepayment_cards')}` (
   `entity_id` int(10) unsigned NOT NULL auto_increment,
   `customer_id` varchar(255) NOT NULL default '',
   `card_id`  varchar(255) NOT NULL default '',
   `bin` varchar(7) NOT NULL default '',
   `card_number`  varchar(7) NOT NULL default '',
   'save_card' varchar(1) not NULL default '',
