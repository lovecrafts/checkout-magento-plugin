...
class CheckoutApi_ChargePayment_Model_Adminhtml_System_Config_Source_PaymentMode
{
    ...
    public function toOptionArray()
    {
        return array(
            array(
                'value' => CheckoutApi_ChargePayment_Model_Hosted::PAYMENT_MODE_MIXED,
                'label' => Mage::helper('chargepayment')->__('Mixed')
            ),
            array(
                'value' => CheckoutApi_ChargePayment_Model_Hosted::PAYMENT_MODE_CARD,
                'label' => Mage::helper('chargepayment')->__('Card')
            ),
            array(
                'value' => CheckoutApi_ChargePayment_Model_Hosted::PAYMENT_MODE_LOCAL_PAYMENT,
